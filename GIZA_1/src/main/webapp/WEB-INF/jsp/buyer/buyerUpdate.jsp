...
<nav class="navbar fixed-navbar navbar-expand-lg navbar-light bg-light">
	...
	<form method="post" action="/buyer"
		...
		<c:forEach var="error" items="${errors}">
			...
			<div class="mb-3">
				<label for="formGroupExampleInput1" class="form-label">
					Buyer First Name </label> <input type="text" class="form-control"
			...
			<div class="mb-3">
				<label for="formGroupExampleInput1" class="form-label">
					Buyer Last Name </label> <input type="text" class="form-control"
		...
		<div class="mb-3">
			<label for="formGroupExampleInput1" class="form-label">
				Business Name </label> <input type="text" class="form-control"
		...
		<div class="mb-3">
			<label for="formGroupExampleInput1" class="form-label">
				Buyer Address </label> <input type="text" class="form-control"
